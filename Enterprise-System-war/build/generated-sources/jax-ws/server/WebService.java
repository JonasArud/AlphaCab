 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/WebServiceServer/WebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WebServiceServer/WebService?wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://server/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "WebServicesPort"), WebServices.class, features);
    }
